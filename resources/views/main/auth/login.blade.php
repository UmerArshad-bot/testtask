...
<div id="auth">
    ...
    <div class="row h-100">
        <div class="col-lg-5 col-12">
            <div id="auth-left">
                <div class="auth-logo">
                    <a ><img src="{{'assets/images/logo/logo.png'}}" style="width:320px;height:70px;margin-top:-20px" alt="Logo"></a>
                </div>
...
></script>
<script type="text/javascript" src="{{('assets/vendors/toastify/toastify.js')}}"></script>
